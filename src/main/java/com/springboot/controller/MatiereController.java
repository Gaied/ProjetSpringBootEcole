...
public class MatiereController {
	...
	public String ajoutMatiere(@Valid @ModelAttribute(name = "matiereform") MatiereForm matiereform,
	...
	public String modifieMatiere(@Valid @ModelAttribute(name = "matiereform") MatiereForm matiereform,
			BindingResult presult, Model pmodel) {
		if (!presult.hasErrors()) {
			try {
				Matiere pmatiere = convertForm(matiereform);
